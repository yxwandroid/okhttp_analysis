...
public class OkHttpclient implements Cloneable, Call.Factory, WebSocket.Factory {
  ...
  static {
    Internal.instance = new Internal() {
      ...
      @Override
      public void setHttp2Codec(Response.Builder builder, Http2Codec http2Codec) {
        builder.http2Codec(http2Codec);
      }

      @Override
      public void httpSink(Response.Builder responseBuilder, HttpSink httpSink) {
        responseBuilder.httpSink(httpSink);
      }

      @Override
      public HttpSink httpSink(Response response) {
